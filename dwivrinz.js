...
// SC BYA DWIVRINZ 
// SUBSCRIBE YAK DAH ENAK TINGGAL MAKE
// UBAH OWNER DI SETTING.JSON 
//━━━━━━━━━━━━━━━[ DWIVRINZ ]━━━━━━━━━━━━━━━━━//
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `Subscribe DwiVrinz`, 
                            orderTitle: `Subscribe DwiVrinz`,
...
⬣ Build By : 「 *DwiVrinz* 」
⬣ Subscribe : bit.ly/2ZDdc6S
⬣ Grub Official : bit.ly/3Guhuhq
⬣ Grup Topup Murah : bit.ly/3nBu7yA
_________________________________
「 𝙄𝙉𝙁𝙊 𝘽𝙊𝙏 」
⬣ Bot Name : 「 *${botname}* 」
⬣ Prefix : 「 *Multi* 」
⬣ Runtime : 「 *${runtime(process.uptime())}* 」_________________________________
「 𝙄𝙉𝙁𝙊 𝙆𝘼𝙈𝙐 」
⬣ User Name : ${pushname}
...
{ buttonId: `${prefix}officialgroup`, buttonText: { displayText: '⚖️OFFICIAL GROUP' }, type: 1 }
]
...
sendButton(from, "GOPAY : 081250436957 (DwiVrinz)", faketeks, but, mek)
break
case 'dana':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "DANA : 081250436957 (Dwi)", faketeks, but, mek)
break
case 'ovo':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
...
├❍💎706            =   Rp. 168.220
├❍💎963            =   Rp. 232.450
├ Starlight               =   Rp. 140.000    
├ Twilight Pass      =   Rp. 140.000
├ Starlight +            =   Rp. 320.000
│ *Proses 10 - 180 Menit*
│ *Maksimal 24 jam ketika orderan*
│ *Overload atau error...*
│ *Open Pukul 07:00 - 22:00*
╰─────────────────
...
├❍💎4000     =   Rp. 496.100
├❍💎7290     =   Rp. 910.750
├❍ Member Mingguan =   Rp. 27.900
├❍ Member Bulanan  =   Rp. 137.700
│ *Proses 1 - 15 Menit*
│ *Maksimal 24 jam*
╰─────────────────
...
dwivrinz.sendMessage(from, 'Pertanyaan : *hoby*\n\nJawaban : '+ hooo, text, { quoted: ftrol })
break
case 'bisakah':
bisakah = body.slice(1)
const bisa =['Bisa','Tidak Bisa','Coba Ulangi','MANA GW TAU']
const keh = bisa[Math.floor(Math.random() * bisa.length)]
dwivrinz.sendMessage(from, '*Pertanyaan :* '+bisakah+'\n*Jawaban :* '+ keh, text, { quoted: ftrol })
break
case 'citacita':       
...
dwivrinz.sendMessage(from, cita2, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true, duration: -838719282910})
break
case 'kapankah':
kapankah = body.slice(1)
const kapan =['Besok','Lusa','Tadi','4 Hari Lagi','5 Hari Lagi','6 Hari Lagi','1 Minggu Lagi','2 Minggu Lagi','3 Minggu Lagi','1 Bulan Lagi','2 Bulan Lagi','3 Bulan Lagi','4 Bulan Lagi','5 Bulan Lagi','6 Bulan Lagi','1 Tahun Lagi','2 Tahun Lagi','3 Tahun Lagi','4 Tahun Lagi','5 Tahun Lagi','6 Tahun Lagi','1 Abad lagi','3 Hari Lagi']
const koh = kapan[Math.floor(Math.random() * kapan.length)]
dwivrinz.sendMessage(from, '*Pertanyaan :* '+kapankah+'\n*Jawaban :* '+ koh, text, { quoted: ftrol })
break
...
dwivrinz.sendMessage(from, truteh, image, { caption: '*TRUTH*\n\n'+ ttrth, quoted: ftrol })
break
case 'dare':
...
dwivrinz.sendMessage(from, tod, image, { quoted: ftrol, caption: '*DARE*\n\n'+ der })
break
case 'caklontong':
anu = await fetchJson(`https://velgrynd.herokuapp.com/api/caklontong`, {method: 'get'})
get = `*${anu.result.soal}*`
setTimeout( () => {
dwivrinz.sendMessage(from, 'Jawaban: '
+anu.result.jawaban, text, {quoted: ftrol})
}, 60000) // 1000 = 1s,
setTimeout( () => {
dwivrinz.sendMessage(from, '_10 Detik lagi..._', text) 
}, 50000) // 1000 = 1s,
setTimeout( () => {
dwivrinz.sendMessage(from, '_20 Detik lagi..._', text) 
}, 40000) // 1000 = 1s,
setTimeout( () => {
dwivrinz.sendMessage(from, '_30 Detik lagi..._', text) 
}, 30000) // 1000 = 1s,
setTimeout( () => {
dwivrinz.sendMessage(from, '_40 Detik lagi..._', text) 
}, 20000) // 1000 = 1s,
setTimeout( () => {
dwivrinz.sendMessage(from, '_50 Detik lagi..._', text) 
}, 10000) // 1000 = 1s,
setTimeout( () => {
dwivrinz.sendMessage(from, '_60 Detik lagi..._', text) 
}, 2500) // 1000 = 1s,
setTimeout( () => {
dwivrinz.sendMessage(from, get, text, {quoted: ftrol}) 
}, 0) // 1000 = 1s,
break
case 'tebaktebakan':
...
setTimeout( () => {
dwivrinz.sendMessage(from, tebakjenaka, text, {quoted: ftrol}) 
}, 0) // 1000 = 1s,
break
...
dwivrinz.sendMessage(`6281250436957@s.whatsapp.net`,`6282293295376@s.whatsapp.net`, options, text, { quoted: ftrol })
...
case 'tqto':
but = [
{ buttonId: `${prefix}dwivrinz`, buttonText: { displayText: 'DWIVRINZ' }, type: 1 },
{ buttonId: `${prefix}officialgroup`, buttonText: { displayText: 'OFFICIAL GROUP' }, type: 1 }
]
...
case 'bugreport':
              ...
              dwivrinz.sendMessage('6281250436947@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
case 'officialgroup':
but = [
{ buttonId: `${prefix}menu`, buttonText: { displayText: 'MENU' }, type: 1 },
]
sendButton(from, "Grub Official : bit.ly/3Guhuhq\nGrup Topup Murah : bit.ly/3nBu7yA", faketeks, but, mek)
break
